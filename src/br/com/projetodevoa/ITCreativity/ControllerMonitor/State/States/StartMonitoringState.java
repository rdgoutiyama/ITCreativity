...
public class StartMonitoringState implements InteractionMonitorState{

	@Override
	public boolean stateOperation(InteractionMonitor interactionMonitor) {
		if(interactionMonitor instanceof ControllerDepth){
			((ControllerDepth) interactionMonitor).startMonitoring();
			
			return true;
		}else if(interactionMonitor instanceof ControllerWebCam){
			((ControllerWebCam) interactionMonitor).startMonitoring();
			return true;
		}
